                ...
                <div className="grid grid-cols-4 gap-3">
                  {editId && (
                    <div>
                      ...
                      <div className={`${inputCls} bg-gray-50 border-gray-200 text-[#1A6B4A] font-mono font-bold cursor-default select-none`}>
                        {(clients.findIndex(x => x.id === editId) + 1).toString().padStart(3, '0')}
                      </div>
                    </div>
                  )}
                  <div className={editId ? 'col-span-3' : 'col-span-4'}>
