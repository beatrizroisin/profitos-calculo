...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!company) {
      ...
      return await createCollaborator(fallbackCompany, data);
    }

    return await createCollaborator(company, data);
...
async function createCollaborator(company: any, data: any) {
