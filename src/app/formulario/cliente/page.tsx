      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={submit} className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* ── SERVIÇOS — DENTRO do grid com col-span-2 ── */}
            <div className="col-span-2 mt-4 mb-1 border-b border-green-100 pb-1">
              <p className="text-[10px] font-black text-[#1A6B4A] uppercase tracking-[0.2em]">Serviços Contratados</p>
            </div>
            <div className="col-span-2 space-y-4" ref={(el) => { errorRefs.current['servicosContratados'] = el; }}>
          ...
          </div> {/* fecha grid DEPOIS dos serviços */}
