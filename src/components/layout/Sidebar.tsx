...
const NAV: {section:string; items:NavItem[]}[] = [
  ...
  {section:'Equipe & Clientes', items:[
    ...
    {href:'/colaboradores', label:'Colaboradores', icon:'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', minRole:'MANAGER'},
    ...
    {href:'/parceiros', label:'Parceiros', icon:'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', minRole:'MANAGER'},
  ]},
      ...
      <div className="px-4 py-3 border-t border-gray-100">
        <div className="flex items-center gap-2 px-2 py-2 bg-gray-50 rounded-lg">
          ...
          <span className="text-[9px] bg-[#E8F5EF] text-[#1A6B4A] px-1.5 py-0.5 rounded font-semibold flex-shrink-0">
            {{OWNER:'OWN',ADMIN:'ADM',MANAGER:'MGR',MEMBER:'MBR',VIEWER:'VWR'}[userRole]||userRole}
          </span>
        </div>
      </div>
    </aside>
